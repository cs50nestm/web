# Changemaker Project: Generative AI
## tl;dr
Research generative AI, analyze its impact, and propose your own recommendations.
...
This is a research, analysis, and advocacy project. Your voice and your argument matter here.
You may work alone or with a partner (max 2).

Projects will be presented to the class or submitted as a website at the end of the unit.

## What Your Project Must Cover
...
Pick at least three angles to explore:
	...
	- Ethics: bias, copyright and IP, misinformation and deepfakes
	- Environment: the energy cost of training large models
...
**Option A: Website**
Built with Google Sites, Wix, Weebly, or your own HTML/CSS.
...
- A works cited with at least 5 credible sources (MLA or APA)
- At least 2 original visuals
- Your name(s), class period, and due date
...
What did it do well? Where did it fall short? What ethical questions came up?
