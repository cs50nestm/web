...
*Note: if you do a game as a final project, you need to do only one game code-a-long, either Pong or Flappy.*
	...
	- **[Snake](https://www.youtube.com/watch?v=OMoVcohRgZA), [Space Invaders or other games](https://thecodingtrain.com/)** using Dan Shiffman's tutorials and adding a unique customization. 
